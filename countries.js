 ...
 function loaddata(data){
     ...
     var row= "<tr><td><h4>Name</h4></td><td><h4>Flag</h4></td><td><h4>Population</h4></td><td><h4>Capital</h4></td></tr>";
     table.innerHTML+=row;
     for (var i=0; i<data.length; i++){
         var row= "<tr><td>"+data[i].name+"</td><td><img src='"+data[i].flag+"'height='42' width='84' style='padding:5px;'></td><td>"+data[i].population+"</td><td>"+data[i].capital+"</td></tr>";
         table.innerHTML+=row;
     }
}